...
- Name: bookings.spec.ts >> E2E Booking Management >> should open Create Booking drawer or modal when Create button is clicked
- Location: tests/e2e/bookings.spec.ts:19:7
